...
import com.beyond.n_interface.practice.SmartPhone;
import com.beyond.n_interface.practice.Television;
import com.beyond.n_interface.practice.Basic;
import com.beyond.n_interface.practice.Desktop;

public class InterfaceApplication {
    public static void main(String[] args) {
        /**
         * 1. 인터페이스는 객체 생성이 불가능하다.
         *  - 인터페이스를 구현하는 클래스를 통해서 객체를 생성해야 한다.
         * 2. 인터페이스는 참조 변수로 사용이 가능하다.
