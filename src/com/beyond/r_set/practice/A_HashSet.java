package com.beyond.r_set.practice;
...
public class A_HashSet {
    public void method1() {
        ...
        //  - 가져올 객체가 있는 지 확인할 때 hasNext() 메소드를 사용한다.
        ...
        iterator.forEachRemaining((t) -> System.out.println("_lambda"));
        iterator.forEachRemaining(System.out::println);

    }
    public void method2() {
        Set<Music> set = new HashSet<>();
        set.add(new Music("Hot Sweet", "뉴진스", 1));
        set.add(new Music("Hot Sweet", "뉴진스", 1));
        set.add(new Music("소나기", "이클립스", 3));
        set.add(new Music("해야", "아이브", 6));
        set.add(new Music("해야", "아이브", 6));
        set.add(new Music("Drama", "에스파", 5));
        set.add(new Music("ETA", "뉴진스", 4));
